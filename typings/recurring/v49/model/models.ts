...
import localVarRequest = require('request');
 ...
 import { DisableRequest } from './disableRequest.ts';
 import { DisableResult } from './disableResult.ts';
 import { Name } from './name.ts';
 import { Recurring } from './recurring.ts';
 import { RecurringDetail } from './recurringDetail.ts';
 import { RecurringDetailsRequest } from './recurringDetailsRequest.ts';
 import { RecurringDetailsResult } from './recurringDetailsResult.ts';
 import { ScheduleAccountUpdaterRequest } from './scheduleAccountUpdaterRequest.ts';
 import { ScheduleAccountUpdaterResult } from './scheduleAccountUpdaterResult.ts';
